...
INSERT INTO usuarios VALUES (2, 'Buki', AES_ENCRYPT('tu_carcel', 'recuerda'));
INSERT INTO usuarios VALUES (3, 'NoToi', AES_ENCRYPT('password', '1234'));
...
SELECT id_usuario, usuario, CAST(AES_DECRYPT(contraseña, 'recuerda') AS CHAR(255)) AS contraseña FROM usuarios WHERE id_usuario = 2;
SELECT id_usuario, usuario, CAST(AES_DECRYPT(contraseña, '1234') AS CHAR(255)) AS contraseña FROM usuarios WHERE id_usuario = 3;