...
import { Container, Row, Form, FormGroup, FormControl, FormLabel, Button, Alert, Table, Col, bordered, striped, hover } from "react-bootstrap";
          ...
          <Form>
            <Form.Row>
              ...
              <Col sm={4}>
                ...
                <FormControl type="text" name="telefono1" placeholder="Ingrese el telefono." onChange={this.handleChange} value={this.state.telefono1} />
              </Col>
              <Col sm={2}> </Col>
              <Col sm={2}> </Col>
              <Col sm={4}>
